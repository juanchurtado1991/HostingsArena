"""Liquid Web scraper (MVP - simple version)"""
...
class LiquidWebScraper(BaseHostingScraper):
    BASE_URL = "https://liquidweb.com"
    
    def scrape_plans(self) -> List[HostingProvider]:
        """Simple scraper with basic data (will enhance later)"""
        return [HostingProvider(
            provider_name='Liquid Web',
            provider_type='vps',
            plan_name='Basic',
            website_url=self.BASE_URL,
            pricing_monthly=15.0,
            storage_gb=25 if 'vps' == 'cloud' else 10,
            storage_type=StorageType.SSD,
            bandwidth='unlimited',
            web_server=WebServer.NGINX if 'vps' == 'cloud' else WebServer.APACHE,
            ...
            control_panel='Custom' if 'vps' == 'cloud' else 'cPanel',
