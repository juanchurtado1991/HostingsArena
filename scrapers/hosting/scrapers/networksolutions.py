"""Network Solutions Scraper (Adaptive)"""
...
class NetworkSolutionsScraper(BaseHostingScraper):
    def __init__(self):
        super().__init__(provider_name="Network Solutions")
    ...
    def scrape_plans(self) -> List[HostingProvider]:
        ...
        for p in verified_plans:
            providers.append(HostingProvider(
                provider_name="Network Solutions",
                provider_type='shared',
                plan_name=p['name'],
                website_url="https://www.networksolutions.com",
