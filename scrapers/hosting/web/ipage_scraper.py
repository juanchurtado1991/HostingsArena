...
class iPageScraper(BaseHostingScraper):
    def __init__(self):
        super().__init__()
        self.name = "iPage"
        self.url = "https://www.ipage.com"

    def scrape_plans(self):
        # TODO: Implement specific selectors for iPage
        # Returning placeholder Tier 2 plan for MVP
         return [
             HostingProvider(
                ...
                storage_gb=50,
                bandwidth="Unlimited",
                website_url="https://www.ipage.com",
                features={
                    "ssl": True,
                    "domain": False,
                    "backups": True
                ...
                money_back_days=30,
                raw_data={
                    "notes": "Placeholder data for iPage - pending scraper refinement"
                }
             )
         ]