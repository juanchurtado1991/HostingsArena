...
class InterServerScraper(BaseHostingScraper):
    def __init__(self):
        super().__init__()
        self.name = "InterServer"
        self.url = "https://www.interserver.net"

    def scrape_plans(self):
        # TODO: Implement specific selectors for InterServer
        # Returning placeholder Tier 2 plan for MVP
         return [
             HostingProvider(
                ...
                money_back_days=30,
                raw_data={
                    "notes": "Placeholder data for InterServer - pending scraper refinement"
                }
             )
         ]