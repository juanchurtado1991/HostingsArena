...
class RoseHostingScraper(BaseHostingScraper):
    def __init__(self):
        super().__init__()
        self.name = "RoseHosting"
        self.url = "https://www.rosehosting.com"

    def scrape_plans(self):
        # TODO: Implement specific selectors for RoseHosting
        # Returning placeholder Tier 2 plan for MVP
         return [
             HostingProvider(
                ...
                money_back_days=30,
                raw_data={
                    "notes": "Placeholder data for RoseHosting - pending scraper refinement"
                }
             )
         ]