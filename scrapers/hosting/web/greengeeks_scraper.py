...
class GreenGeeksScraper(BaseHostingScraper):
    def __init__(self):
        super().__init__()
        self.name = "GreenGeeks"
        self.url = "https://www.greengeeks.com"

    def scrape_plans(self):
        # TODO: Implement specific selectors for GreenGeeks
        # Returning placeholder Tier 2 plan for MVP
         return [
             HostingProvider(
                ...
                money_back_days=30,
                raw_data={
                    "notes": "Placeholder data for GreenGeeks - pending scraper refinement"
                }
             )
         ]