"""Freegate Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class FreegateScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="Freegate")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "Freegate",
            'website_url': "https://www.freegate.com",
