"""Sentinel dVPN Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class SentineldVPNScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="Sentinel dVPN")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "Sentinel dVPN",
            'website_url': "https://www.sentineldvpn.com",
