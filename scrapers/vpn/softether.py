"""SoftEther Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class SoftEtherScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="SoftEther")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "SoftEther",
            'website_url': "https://www.softether.com",
