"""Norton Secure VPN Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class NortonSecureVPNScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="Norton Secure VPN")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "Norton Secure VPN",
            'website_url': "https://www.nortonsecurevpn.com",
