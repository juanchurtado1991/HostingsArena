"""UltraSurf Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class UltraSurfScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="UltraSurf")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "UltraSurf",
            'website_url': "https://www.ultrasurf.com",
