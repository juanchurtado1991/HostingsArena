"""OpenVPN Cloud Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class OpenVPNCloudScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="OpenVPN Cloud")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "OpenVPN Cloud",
            'website_url': "https://www.openvpncloud.com",
