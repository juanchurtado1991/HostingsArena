"""SaferVPN Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class SaferVPNScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="SaferVPN")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "SaferVPN",
            'website_url': "https://www.safervpn.com",
