"""Touch VPN Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class TouchVPNScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="Touch VPN")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "Touch VPN",
            'website_url': "https://www.touchvpn.com",
