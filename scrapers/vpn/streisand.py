"""Streisand Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class StreisandScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="Streisand")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "Streisand",
            'website_url': "https://www.streisand.com",
