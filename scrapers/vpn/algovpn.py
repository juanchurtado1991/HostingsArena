"""Algo VPN Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class AlgoVPNScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="Algo VPN")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "Algo VPN",
            'website_url': "https://www.algovpn.com",
