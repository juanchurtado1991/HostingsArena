"""McAfee VPN Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class McAfeeVPNScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="McAfee VPN")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "McAfee VPN",
            'website_url': "https://www.mcafeevpn.com",
