"""HideMyName Scraper (Adaptive)"""
from .base_scraper import BaseVPNScraper
from ..models import VPNProvider
from datetime import datetime

class HideMyNameScraper(BaseVPNScraper):
    def __init__(self):
        super().__init__(provider_name="HideMyName")
        
    def scrape_pricing(self) -> dict:
        return {
            'provider_name': "HideMyName",
            'website_url': "https://www.hidemyname.com",
