                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 text-zinc-900 dark:text-zinc-100 font-semibold">
                                        ...
                                        <span className="text-sm">
                                            {activeLang === 'en' ? "Content for X (Twitter)" : "Contenido para X (Twitter)"}
                                        </span>
                                    </div>
                                    {twitterFullText && (
                                        <button
                                ...
                                <div className="relative group">
                                    <textarea
                                        ...
                                        value={twitterFullText || (activeLang === 'en' ? "No content generated" : "Sin contenido generado")}
                                    />
                                    {twitterFullText && (
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 text-zinc-900 dark:text-zinc-100 font-semibold">
                                        ...
                                        <span className="text-sm">
                                            {activeLang === 'en' ? "Content for Facebook" : "Contenido para Facebook"}
                                        </span>
                                    </div>
                                    {facebookFullText && (
                                        <button
                                ...
                                <div className="relative group">
                                    <textarea
                                        readOnly
                                        className="w-full h-24 p-4 text-xs font-mono bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-800 rounded-2xl resize-none text-zinc-600 dark:text-zinc-400 focus:outline-none"
                                        value={facebookFullText || (activeLang === 'en' ? "No content generated" : "Sin contenido generado")}
                                    />
                                    {facebookFullText && (
                                        <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl pointer-events-none flex items-center justify-center">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 text-zinc-900 dark:text-zinc-100 font-semibold">
                                        ...
                                        <span className="text-sm">
                                            {activeLang === 'en' ? "Content for LinkedIn" : "Contenido para LinkedIn"}
                                        </span>
                                    </div>
                                    {linkedinFullText && (
                                        <button
                                ...
                                <div className="relative group">
                                    <textarea
                                        readOnly
                                        className="w-full h-32 p-4 text-xs font-mono bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-800 rounded-2xl resize-none text-zinc-600 dark:text-zinc-400 focus:outline-none"
                                        value={linkedinFullText || (activeLang === 'en' ? "No content generated" : "Sin contenido generado")}
                                    />
                                    {linkedinFullText && (
                                        <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl pointer-events-none flex items-center justify-center">
                                            <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-500">
